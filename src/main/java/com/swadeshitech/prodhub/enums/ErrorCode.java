...
public enum ErrorCode {
        ...
        METADATA_PROFILE_UPDATE_FAILED("PH-6003", "Meta data profile could not be updated",
                        HttpStatus.INTERNAL_SERVER_ERROR),
        METADATA_PROFILE_LIST_NOT_FOUND("PH-6004", "Meta data profile list could not found", HttpStatus.NOT_FOUND),
        METADATA_PROFILE_REFERENCED("PH-6005", "Meta data profile is referenced with other profiles",
                        HttpStatus.BAD_REQUEST),
        METADATA_PROFILE_INVALID_RELATION("PH-6006", "Meta data profile has invalid relation", HttpStatus.BAD_REQUEST),
        METADATA_PROFILE_INVALID_DATA("PH-6007", "Meta data profile has invalid data", HttpStatus.BAD_REQUEST),
        METADATA_PROFILE_REFERENCED_NOT_FOUND("PH-6008", "Referenced Meta data profile could not found",
                        HttpStatus.BAD_REQUEST),
        ...
        ORGANIZATION_COULD_NOT_BE_REGISTERED("PH-13003", "Organization could not be registered",
                        HttpStatus.BAD_REQUEST),
